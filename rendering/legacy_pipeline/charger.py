...
from rendering._render_config import canvas, tinctures, charge_loc, charge_size, charges, all_tinctures, charge_detail
...
def draw_feature_quarterly_of_eight(tincture_list, shape, dof, division):
    global surface, context
    fess_line = charge_detail["qoe"][dof][division][shape]["fess"]
    dexter_line = charge_detail["qoe"][dof][division][shape]["dexter"]
    pale_line = charge_detail["qoe"][dof][division][shape]["pale"]
    sinister_line = charge_detail["qoe"][dof][division][shape]["sinister"]
...
def draw_feature_label(feature_tincture, quantity, shape, dof, division):
    ...
    bar_h = charge_detail["label"][dof][division][shape]["bar_h"]
    bar_y = charge_detail["label"][dof][division][shape]["bar_y"]
    center = charge_detail["label"][dof][division][shape]["center"]
    spacing = charge_detail["label"][dof][division][shape]["spacing"]
